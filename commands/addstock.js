...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('addstock')
        .setDescription('[Loja Stock] Adiciona um novo produto didaticamente')
        .addStringOption(opt => opt.setName('nome').setDescription('Nome do veículo/produto').setRequired(true)),
    adminOnly: true,
    async execute(interaction) {
        ...
        collector.on('collect', async i => {
            if (i.customId === 'stock_step1') {
                ...
                // Coletor de Mensagem para a Saudação
                ...
                msgCollector.on('collect', async msg => {
                    ...
                    // Agora pede Preço e Quantidade (pode ser via Modal para ficar lindo, mas vamos no chat para ser rápido)
                    ...
                    mathCollector.on('collect', async mathMsg => {
                        ...
                        const priceParsed = parseKK(priceText); // Usa nosso conversor!
