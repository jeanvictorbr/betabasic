module.exports = function generateDevMainMenu(botStatus, stats, dailyTokenUsage) {
    // ... (Lógica de status e tokens permanece igual) ...
    ...
    // ---- Monitoramento de Tokens (Lógica igual) ----
    ...
    return [
        {
            ...
            "thumbnail": { "url": "https://i.imgur.com/6nY45Wx.png" },
            "components": [
                ...
                },
                {
                    "type": 1, "components": [
                        // --- NOVO BOTÃO AQUI ---
                        { "type": 2, "style": 1, "label": "Gerenciar FlowCoins", "emoji": { "name": "💰" }, "custom_id": "dev_open_flow_coins" },
