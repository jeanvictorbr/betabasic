// handlers/selects/select_ausencia_canal_logs.js
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await db.query(`UPDATE guild_settings SET ausencias_canal_logs = $1 WHERE guild_id = $2`, [selectedChannelId, interaction.guild.id]);
