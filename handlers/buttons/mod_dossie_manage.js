// Substitua o conteúdo em: handlers/buttons/mod_dossie_manage.js
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const dossiePayload = await generateDossieEmbed(interaction, member, history, notes, 0, { manageMode: true });
