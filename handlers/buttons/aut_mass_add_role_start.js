// handlers/buttons/aut_mass_add_role_start.js
const { V2_FLAG, EPHEMERAL_FLAG } = require('../../utils/constants');
const { PermissionFlagsBits } = require('discord.js');

module.exports = {
    customId: 'aut_mass_add_role_start',
    async execute(interaction) {
        ...
        const payload = {
            ...
            flags: EPHEMERAL_FLAG | V2_FLAG,
            components: [
                { type: 10, content: "## ➕ Adicionar Cargo a Todos\nSelecione o cargo que você deseja **ADICIONAR** a **TODOS** os membros do servidor." },
                {
                    type: 1,
                    components: [
                        {
                            ...
                            // --- FIM DA CORREÇÃO ---
                            custom_id: 'aut_mass_add_role_select',
