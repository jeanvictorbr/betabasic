// handlers/buttons/aut_mass_remove_role_confirm_.js
const { V2_FLAG, EPHEMERAL_FLAG } = require('../../utils/constants');
const runMassRoleTask = require('../../utils/massRoleTask'); // Importa a nova função

module.exports = {
    customId: 'aut_mass_remove_role_confirm_',
    async execute(interaction) {
        ...
        runMassRoleTask(
            ...
            'remove',
            'all', // Filtro
            'Remover cargo (Todos os Membros)'
        );
        ...
        const payload = {
            type: 17,
            components: [
                { type: 10, content: `## ✅ Tarefa Iniciada\nIniciando a remoção do cargo <@&${roleId}> de **todos** os membros em segundo plano.` },
