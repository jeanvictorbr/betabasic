...
module.exports = {
    customId: 'suggestions_publish_vitrine',
    async execute(interaction) {
        const selectMenu = new ChannelSelectMenuBuilder().setCustomId('select_suggestions_publish_vitrine').setPlaceholder('Selecione o canal para publicar a vitrine').addChannelTypes(ChannelType.GuildText);
