// Crie em: handlers/buttons/global_ranking_show_.js
...
module.exports = {
    customId: 'global_ranking_show_', // Handler dinâmico
    async execute(interaction) {
        await interaction.deferUpdate();
        const type = interaction.customId.split('_')[3];

        const { ranking, total } = await getRankingData(type);
        
        await interaction.editReply({
            components: await generateGlobalRankingMenu(interaction.client, type, ranking, total, 0),
