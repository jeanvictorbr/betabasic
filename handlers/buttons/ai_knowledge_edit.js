// Crie em: handlers/buttons/ai_knowledge_edit.js
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const selectMenu = new StringSelectMenuBuilder().setCustomId('select_ai_knowledge_edit').setPlaceholder('Selecione a entrada para editar').addOptions(options);
