...
module.exports = {
    ...
    async execute(interaction) {
        const selectMenu = new ChannelSelectMenuBuilder().setCustomId('select_welcome_channel').setPlaceholder('Selecione o canal para as boas-vindas').addChannelTypes(ChannelType.GuildText);
