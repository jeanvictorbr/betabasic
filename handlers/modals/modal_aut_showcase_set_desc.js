// File: handlers/modals/modal_aut_showcase_set_desc.js
...
module.exports = {
    customId: 'modal_aut_showcase_set_desc',
    async execute(interaction) {
        ...
        try {
            await db.query(
                ...
                [interaction.guild.id, JSON.stringify({ description: description })]
            );
            ...
            console.error("Erro ao salvar descrição da vitrine:", error);
        }
    }
};