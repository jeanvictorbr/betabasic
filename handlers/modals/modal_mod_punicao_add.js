// Crie em: handlers/modals/modal_mod_punicao_add.js
...
module.exports = {
    customId: 'modal_mod_punicao_add',
    async execute(interaction) {
        ...
        await db.query(
            'INSERT INTO moderation_punishments (guild_id, name, action, duration, role_id) VALUES ($1, $2, $3, $4, $5)',
